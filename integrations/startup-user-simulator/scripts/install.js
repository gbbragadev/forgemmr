...
function usage() {
  console.log(`
Codex Startup User Simulator Skill installer

Usage:
  npx codex-startup-user-simulator-skill
  codex-startup-user-simulator-skill --skills-dir ~/.codex/skills
...
function main() {
  ...
  const source = path.resolve(__dirname, "..", "startup-user-simulator");
  const skillsDir = path.resolve(options.skillsDir || defaultSkillsDir());
  const destination = path.join(skillsDir, "startup-user-simulator");
  ...
  console.log("Installed startup-user-simulator skill.");
