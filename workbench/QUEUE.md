...
- [ ] **L0/P1** Content hooks + brief fake-door DOKI//CALL (`o-anima-deck`) — 15 hooks PT-BR+EN, CTA R$ 4,90, métrica áudio→clique · `docs/prompts/L0-P1-content-hooks.md`
...
- [x] **L0/P0** prova-3x — forge/fake-dry (2026-07-12)
